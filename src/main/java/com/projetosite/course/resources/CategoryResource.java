...
import com.projetosite.course.service.CategoryService;
...
public class CategoryResource {
	...
	public ResponseEntity<Category> findById (@PathVariable Long id){//end point para buscar o usuário pelo id
